...
public class AuthorizationServerConfiguration {
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()
                ...
                //acess_token: token para renovar o access_token
    ...
    public JWKSource<SecurityContext> jwkSource()  throws Exception {
        RSAKey rsaKey = gerarChaveRSA(); // Chave criptográfica assimétrica
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                ...
                //pra consultar status do token
                .tokenIntrospectionEndpoint("/oauth2/introspect")
                //revogar
                .tokenRevocationEndpoint("/oauth2/revoke")
                .authorizationEndpoint("/oauth2/authorize")
                //infomações do usuário OPEN ID CONNECT
                .oidcUserInfoEndpoint("/oauth2/userinfo")
                // obter a chave pública para verificar assinatura do token
